...
import { HeadOfficeExpensesData } from './MultiStepForm';
import { validateNumericInput, isFormValid, getEmptyFields } from '../utils/validation';

interface HeadOfficeExpensesFormProps {
  data: HeadOfficeExpensesData;
  setData: (data: HeadOfficeExpensesData) => void;
  onNext: () => void;
  onBack: () => void;
}

const HeadOfficeExpensesForm: React.FC<HeadOfficeExpensesFormProps> = ({ data, setData, onNext, onBack }) => {
      ...
      <div className="p-8">
        <div className="border-b border-gray-200 pb-4 mb-8">
          ...
          <p className="text-gray-500 mt-2" style={{ fontFamily: 'Montserrat, sans-serif', fontWeight: 500 }}>
            Please enter your Head Office expense details here (All values to exclude vat where applicable)
          </p>
        </div>
...
export default HeadOfficeExpensesForm;